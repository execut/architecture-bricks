...
func (s *Service) ApproveProduct(ctx context.Context, params contract.ApproveProduct) error {
    ...
    return s.repository.ApproveProduct(ctx, productID, params.ModeratorID, event)
}
...
func (s *Service) RejectProduct(ctx context.Context, params contract.RejectProduct) error {
    ...
    return s.repository.RejectProduct(ctx, productID, params.ModeratorID, event)
}
...
func (s *Service) UpdateProduct(ctx context.Context, params contract.UpdateProduct) error {
    ...
    existingProduct, err := s.repository.GetProduct(ctx, productID)
    if err != nil {
        return err
    }
    ...
    if err = s.repository.UpdateProduct(ctx, product, eventList...); err != nil {
        return err
    }
